...
Gem::Specification.new do |spec|
  ...
  spec.description = 'A flexible, extensible price calculator for Ruby applications that computes ' \
                     'the final cost of a product based on configurable business rules.'
